...
public class JsonUtil: NSObject {
     ...
     *  Json转对象
     */
    public static func jsonToModel(_ jsonStr:String,_ modelType:HandyJSON.Type) -> HandyJSON {
     ...
     *  字典转对象
     */
    public static func dictionaryToModel(_ dictionStr:[String:Any],_ modelType:HandyJSON.Type) -> HandyJSON {
